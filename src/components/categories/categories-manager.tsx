      ...
      <div className="flex items-center justify-between">
        <div className="inline-flex p-0.5 bg-[#F1F3F5] dark:bg-[#1A1A20] rounded-lg border border-[#E5E7EB] dark:border-[#27272A]">
          <button
            ...
            className={cn(
              'px-3.5 py-1.5 rounded-md text-xs font-bold transition-colors cursor-pointer',
              tab === 'expense'
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2.5">
          {filtered.map((cat) => (
            <button
              ...
              className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-[#121215] border border-[#E5E7EB] dark:border-[#27272A] hover:border-[#0F172A] dark:hover:border-[#FAFAFA] transition-colors cursor-pointer text-left group"
            >
