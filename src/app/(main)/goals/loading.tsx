...
export default function GoalsLoading() {
  return (
    <div className="flex flex-col gap-6 animate-pulse" aria-busy="true" aria-live="polite">
      ...
      {/* Summary Stat Card */}
      <div className="h-28 w-full rounded-2xl bg-white dark:bg-[#121215] border border-[#E5E7EB] dark:border-[#27272A] p-6 shadow-xs flex justify-between items-center">
        <div className="flex flex-col gap-2">
          <div className="h-3.5 w-32 rounded-md bg-[#E2E8F0] dark:bg-[#1E293B]" />
          <div className="h-8 w-48 rounded-lg bg-[#CBD5E1] dark:bg-[#334155]" />
        </div>
        <div className="h-10 w-20 rounded-xl bg-[#F1F5F9] dark:bg-[#1E293B]" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="h-48 rounded-2xl bg-white dark:bg-[#121215] border border-[#E5E7EB] dark:border-[#27272A] p-5 flex flex-col justify-between shadow-xs"
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="h-3 w-full rounded-full bg-[#E2E8F0] dark:bg-[#1E293B]" />
            </div>
            <div className="flex justify-between items-center pt-3 border-t border-[#F1F5F9] dark:border-[#1E293B]">
